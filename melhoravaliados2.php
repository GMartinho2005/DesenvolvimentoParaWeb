...
<div class="flex-grow-1">
    <div class="container my-5">
        ...
        <div class="pb-3 mb-4 border-bottom">
            <h1 class="h2 fw-bold">Melhor Avaliados</h1>
            <p class="text-muted">Os livros com a melhor avaliação da nossa estante digital.</p>
        </div>
        ...
        <div aria-label="Navegação de páginas" class="mt-4">
            <ul class="pagination justify-content-center">
                <li class="page-item"><a class="page-link" href="melhoravaliados.php">Anterior</a></li>
                <li class="page-item"><a class="page-link" href="melhoravaliados.php">1</a></li>
                <li class="page-item active"><a class="page-link" href="#">2</a></li>
                <li class="page-item"><a class="page-link" href="melhoravaliados3.php">3</a></li>
                <li class="page-item"><a class="page-link" href="melhoravaliados3.php">Próximo</a></li>
            </ul>
        </div>

...
<div class="flex-grow-1">
    <div class="banner-container position-relative text-white banner-img-container">
        <img src="imgs/romance.jpeg" class="banner-img">
        <div class="banner-content mx-auto p-3 p-md-0 text-center text-md-start">
            <h1 class="fw-bold display-6">Histórias de amor que aquecem a alma</h1>
        </div>
    </div>
    ...
    <div class="container my-5">
        ...
        <div class="pb-3 mb-4 border-bottom">
            <h1 class="h2 fw-bold">Romance</h1>
        </div>
        ...
        <div aria-label="Navegação de páginas" class="mt-4">
            <ul class="pagination justify-content-center">
                ...
                <li class="page-item"><a class="page-link" href="romance2.php">Próximo</a></li>
            </ul>
        </div>

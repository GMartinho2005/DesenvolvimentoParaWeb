...
<div class="flex-grow-1">
    <div class="banner-container position-relative text-white banner-img-container">
        <img src="imgs/classica.jpeg" class="banner-img">
        <div class="banner-content mx-auto p-3 p-md-0 text-center text-md-start">
            <h1 class="fw-bold display-6">Obras que desafiam o tempo. Histórias que ficam para sempre</h1>
        </div>
    </div>
    ...
    <div class="container my-5">
        ...
        <div class="pb-3 mb-4 border-bottom">
            <h1 class="h2 fw-bold">Literatura Clássica</h1>
        </div>

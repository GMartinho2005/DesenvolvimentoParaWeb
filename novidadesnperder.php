...
<div class="flex-grow-1">
    <div class="container my-5">
        ...
        <div class="pb-3 mb-4 border-bottom">
            <h1 class="h2 fw-bold">Novidades a Não Perder</h1>
            <p class="text-muted">Os livros adicionados recentemente</p>
        </div>
        ...
        <div aria-label="Navegação de páginas" class="mt-4">
            <ul class="pagination justify-content-center">
                ...
                <li class="page-item"><a class="page-link" href="novidadesnperder2.php">2</a></li>
                <li class="page-item"><a class="page-link" href="novidadesnperder2.php">Próximo</a></li>
            </ul>
        </div>

...
<div class="flex-grow-1">
    <div class="banner-container position-relative text-white banner-img-container">
        <img src="imgs/historia.jpeg" class="banner-img">
        <div class="banner-content mx-auto p-3 p-md-0 text-center text-md-start">
            <h1 class="fw-bold display-6">Viage no tempo. Conheça os eventos que mudaram o mundo</h1>
        </div>
    </div>
    ...
    <div class="container my-5">
        ...
        <div class="pb-3 mb-4 border-bottom">
            <h1 class="h2 fw-bold">História</h1>
        </div>
        ...
        <div aria-label="Navegação de páginas" class="mt-4">
            <ul class="pagination justify-content-center">
                ...
                <li class="page-item"><a class="page-link" href="historia2.php">2</a></li>
                <li class="page-item"><a class="page-link" href="historia2.php">Próximo</a></li>
            </ul>
        </div>

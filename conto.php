...
<div class="flex-grow-1">
    <div class="banner-container position-relative text-white banner-img-container">
        <img src="imgs/conto.jpeg" class="banner-img">
        <div class="banner-content mx-auto p-3 p-md-0 text-center text-md-start">
            <h1 class="fw-bold display-6">Viagens rápidas a universos extraordinários</h1>
        </div>
    </div>
    ...
    <div class="container my-5">
        ...
        <div aria-label="Navegação de páginas" class="mt-4">
            <ul class="pagination justify-content-center">
                ...
                <li class="page-item"><a class="page-link" href="conto2.php">2</a></li>
                <li class="page-item"><a class="page-link" href="conto2.php">Próximo</a></li>
            </ul>
        </div>
